...
export const releaseArtifacts: ReleaseArtifact[] = [
  {
    id: "plsas-cothern-june25-response-thread",
    lane: "PLSAS",
    group: "Board Emails",
    title: "PLSAS Emailed Again. The Receipt Got Preserved First.",
    eyebrow: "Gmail-style render packet",
    date: "2026-06-26",
    pages: 7,
    smell: "8.9/10",
    description:
      "Public-redacted fake-native Gmail renders preserving the June 25 PLSAS message and the same-thread response draft.",
    href: "/release-assets/plsas/plsas-cothern-june25-response-thread-public-redacted-2026-06-26.pdf",
    sourcePath:
      "communications/evidence/plsas_cothern_june25_public_redacted_2026-06-26/plsas-cothern-june25-response-thread-public-redacted-2026-06-26.pdf"
  },
  {
    id: "administrator-packet",
    lane: "PLSAS",
    group: "Packets",
    title: "Administrator of the Year, Somehow.",
  ...
  },
  {
    ...
    lane: "PLSAS",
    group: "Board Emails",
    title: "The Board Got the Warning. Here's the Receipt.",
    eyebrow: "Board email",
    date: "2026-06-21",
    pages: 1,
    smell: "9.2/10",
  ...
  },
  {
    ...
    lane: "PLSAS",
    group: "Board Emails",
    title: "The Records Could Not All Be True at Once.",
    eyebrow: "Board email",
    date: "2026-06-17",
    pages: 1,
    smell: "9.3/10",
  ...
  },
  {
    ...
    lane: "PLSAS",
    group: "Board Emails",
    title: "Who Touched the Student Records, and Under What Rule?",
    eyebrow: "Board email",
    date: "2026-06-18",
    pages: 1,
    smell: "8.9/10",
  ...
  },
  {
    ...
    lane: "PLSAS",
    group: "Board Emails",
    title: "The \"Surely Someone Logged This\" Email.",
    eyebrow: "Board email",
    date: "2026-06-20",
    pages: 1,
    smell: "8.8/10",
  ...
  },
  {
    ...
    lane: "PLSAS",
    group: "Board Emails",
    title: "They Sent the Record Universe. Then We Read It.",
    eyebrow: "Board email",
    date: "2026-06-20",
    pages: 1,
    smell: "8.4/10",
  ...
  },
  {
    ...
    lane: "PLSAS",
    group: "Board Emails",
    title: "We Offered a Cure Path. The Paper Trail Got Quiet.",
  ...
  },
  {
    ...
    lane: "PLSAS",
    group: "Packets",
    title: "Nothing To See Here, Apparently.",
  ...
  },
  {
    ...
    lane: "PLSAS",
    group: "Packets",
    title: "The Reports Are Redacted. The Problems Are Not.",
    eyebrow: "Annotated investigation records",
    date: "2026-06-25",
    pages: 9,
    smell: "9.7/10",
    description:
      "The District investigated itself, preserved the redactions, and somehow the black boxes are not the worst part.",
  ...
  },
  {
    ...
    title: "A Three-Page Tour of \"That Can't Both Be True.\"",
  ...
  },
  {
    ...
    lane: "PLSAS",
    group: "Governance Notices",
    title: "The \"Show Your FERPA Work\" Packet.",
    eyebrow: "Attached packet",
    date: "2026-06-18",
    pages: 4,
    smell: "8.8/10",
  ...
  },
  {
    ...
    lane: "PLSAS",
    group: "Governance Notices",
    title: "Routine Handling, Mysterious Disclosure Log.",
    eyebrow: "Attached packet",
    date: "2026-06-20",
    pages: 5,
    smell: "8.9/10",
  ...
  },
  {
    ...
    lane: "PLSAS",
    group: "Governance Notices",
    title: "The Data-Practices Posture Needed Adult Supervision.",
    eyebrow: "Attached packet",
    date: "2026-06-20",
    pages: 5,
    smell: "8.3/10",
  ...
  },
  {
    ...
    lane: "PLSAS",
    group: "Governance Notices",
    title: "The District Said Final. The Source Records Had Questions.",
    eyebrow: "Attached packet",
    date: "2026-06-21",
    pages: 10,
    smell: "9.5/10",
  ...
  },
  {
    ...
    lane: "PLSAS",
    group: "Packets",
    title: "Thirty-One Pages of \"This Could Be Easy.\"",
    eyebrow: "Attached packet",
    date: "2026-06-23",
    pages: 31,
    smell: "8.7/10",
  ...
  },
  {
    ...
    lane: "PLSAS",
    group: "Packets",
    title: "The Waiting Room for Simple Answers.",
    eyebrow: "Attached packet",
    date: "2026-06-23",
    pages: 18,
    smell: "8.5/10",
  ...
  },
  {
    ...
    lane: "PLSAS",
    group: "Packets",
    title: "The Red-Box Guide to Waiting.",
    eyebrow: "Attached packet",
    date: "2026-06-23",
    pages: 13,
    smell: "8.6/10",
