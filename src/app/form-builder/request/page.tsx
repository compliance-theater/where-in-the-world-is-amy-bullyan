  ...
  return (
    <main className="page-shell builder-shell">
      <div className="page-heading">
        ...
        <p>
          Generate a branded FERPA/MGDPA access-basis request for disclosure logs, access records, record
          categories, school-official mappings, and the claimed basis for each person who saw the records.
        </p>
      </div>
      <RequestFormBuilder />
    </main>
